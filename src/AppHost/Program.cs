...
void ApplyEnvironmentVariables(IResourceBuilder<ProjectResource> service)
{
    ...
    var GitHubApp_Instance = builder.AddParameter("GITHUBAPP-INSTANCE", "https://github.com/login/oauth/");
    var GitHubApp_Issuer = builder.AddParameter("GITHUBAPP-ISSUER", "https://github.com/login/oauth");
